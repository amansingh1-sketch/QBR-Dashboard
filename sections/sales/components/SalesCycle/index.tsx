...
import type { SalesCycleData } from "@/sections/sales/types";
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
        ...
        <div className="p-6">
          {activeTab === "ae"     && <ByAE     data={data.byAE}     overallMedian={data.overall.medianDays} />}
          {activeTab === "region" && <ByRegion data={data.byRegion} overallMedian={data.overall.medianDays} />}
        </div>
      </div>
    </section>
  );
