...
import type { RegionBreakdown } from "@/lib/types";
...
export default function ByRegion({ data, selectedTypes }: { data: RegionBreakdown[]; selectedTypes: Set<DealTypeKey> }) {
  ...
  return (
    <>
      <div className="flex justify-end gap-5 pb-2 text-xs text-gray-600">
        ...
        <div className="flex items-center gap-1.5"><span className="inline-block h-0.5 w-4 bg-gray-400 rounded" style={{ verticalAlign: "middle" }} /><span className="inline-block h-2 w-2 rounded-full bg-gray-400 -ml-1.5" style={{ verticalAlign: "middle" }} /> Deals</div>
      </div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-2 text-right font-medium text-gray-500">Avg Size</th>
